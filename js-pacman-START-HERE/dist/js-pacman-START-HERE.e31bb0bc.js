...
var gameBoard = _gameBoard.default.createGameBoard(gameGrid, _setup.LEVEL); // Init Setup
...
function gameLoop(pacman, ghosts) {
  ...
  checkCollision(pacman, ghosts); // dot 먹었을시
...
function startGame() {
  ...
  gameBoard.addObject(287, [_setup.OBJECT_TYPE.PACMAN]); // 팩맨 위치에 팩맨 클래스 추가
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13376" + '/');
